                ...
                <div className="container">
                    <div className="row justify-content-center">
                        <div className="col-12 col-md-8 col-lg-6 col-xl-4 border p-4 p-md-5">
                            <div className="mb-4">
                                <h2 className="display-6 fw-bold text-center">Login</h2>
                                        ...
                                        <div className="row gy-3 justify-content-center">
                                            ...
                                            <div className="col-12 mt-5">
                                                <div className="d-grid">
                                                    <button className="btn btn-lg btn-dark rounded-0 fs-6" type="submit">Sign in</button>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
                            ...
                            <div className="row justify-content-center mt-3">
                                <div className="col-10">
                                    <div className="d-flex flex-column gap-3">
                                        <a href="#!" className="btn btn-outline-dark d-flex align-items-center">
                                            ...
                                            <span className="ms-2 flex-grow-1">Continue with Google</span>
                                        </a>
                                        <a href="#!" className="btn btn-outline-dark d-flex align-items-center">
                                            ...
                                            <span className="ms-2 flex-grow-1">Continue with Apple</span>
                                        </a>
                                        <a href="#!" className="btn btn-outline-dark d-flex align-items-center">
                                            ...
                                            <span className="ms-2 flex-grow-1">Continue with Facebook</span>
                                        </a>
                                    </div>
                                </div>
                            </div>
